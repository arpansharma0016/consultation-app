  ...
  <div class="job">
    ...
    <div class="wrapper">
      ...
      <div class="main-container">
        ...
        <div class="searched-jobs jobs-container-margin">
          <Spinner height="200px"></Spinner>
          <div class="searched-bar">
            <div class="searched-show">Showing 46 Jobs</div>
            <div class="searched-sort">
              Options:
              <span class="post-time">Newest Post</span>
              <span class="menu-icon">▼</span>
            </div>
          </div>
          <div class="job-cards">
            <div class="job-card" @click="$router.push('/details')">
